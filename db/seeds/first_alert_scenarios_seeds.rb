...
module FirstAlertScenariosSeeds
  ...
  SCENARIOS = [
    ...
    { siren: "900000005", name: "FA05 Plans apres Plans", entries: { "Liste démo 1ère alerte 2024" => "Plans", "Liste démo 1ère alerte 2025" => "Plans" }, badge_crp: true, badge_non_crp: false, notes: "Plans courant: badge CRP seulement; non-CRP invisible en liste" },
    { siren: "900000006", name: "FA06 Plans seul", entries: { "Liste démo 1ère alerte 2025" => "Plans" }, badge_crp: true, badge_non_crp: false, notes: "Première détection Plans" },
    { siren: "900000007", name: "FA07 Ratios apres Ratios", entries: { "Liste démo 1ère alerte 2024" => "Ratios", "Liste démo 1ère alerte 2025" => "Ratios" }, badge_crp: true, badge_non_crp: false, notes: "Ratios courant: badge CRP seulement" },
